programa
{
	...
	funcao inicio()
	{
		...
		escreva("Vai comprar o que? Digite o codigo do produto:")
		leia(codigo)
		codigo= codigo-1
		pulalinha()
		...
		leia(pgto)
		inteiro desconto1 = ((precos[codigo]-(precos[codigo]*0.20)))
		real desconto2 = ((precos[codigo]-(precos[codigo]*0.15)))
		real desconto3 = (precos[codigo])
		real desconto4 = ((precos[codigo]+(precos[codigo]*0.10)))
		se (pgto == 1){
			escreva("Você pagará R$",desconto1)
		}
		senao se (pgto == 2){
			escreva("Você pagará R$",desconto2)
		}
		senao se (pgto == 3){
			escreva("Você pagará R$",desconto3)	
		}
		senao {
			escreva("Você pagará R$",desconto4)
		}
	}
	funcao pulalinha()
	{
